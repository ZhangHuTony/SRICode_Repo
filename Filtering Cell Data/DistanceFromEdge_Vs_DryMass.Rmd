...
```{r}
model_Barbie <- glm(Stopped.Tracking ~ Dry.Mass+ Dry.Mass_Percent.Change+Distance_From_Edge+Mean.Intensity+Integrated.Intensity, data = Barbie_Df, family = binomial )
