...
```{r}
hex <- hexbin(Barbie_Rescaled_Df$Centered_Position.X, Barbie_Rescaled_Df$Centered_Position.Y)
...
```{r}
ggplot(kenRescaledDf, aes(x = Centered_Position.X, y = Centered_Position.Y, fill = Dry.Mass)) +
